"""
Моделі БД для веб-версії (Этап 1). Джерело істини — Postgres (Railway, DATABASE_PUBLIC_URL) /
...
ProjectData поки лише схема (Этап 1, за рішенням власника): категорії/медіа-кеш/скрипти/
профіль стилю/звіти й досі живуть файлами в project_data_dir() (app/project_store.py) — перенесення
~15 файлових модулів на ProjectData заплановане на Этап 2, не робимо це зараз.
...
def _new_project_id() -> str:
    ...
    # (наприклад, як ім'я каталогу в project_data_dir()), змінювати формат немає причини.
